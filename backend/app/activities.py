...
ACTIVITIES = [
    ...
    activity(
        ...
        "dopamine",
        "폭죽 쏘기",
        "해변에서 바다를 향해 폭죽을 쏘다 심심하면 서로를 향해 쏘며 피해보아요.",
        30,
    ),
    activity(
        "dopamine_03",
        "dopamine",
        "뜨거운 탕에 손가락 넣기",
        "뜨거운 탕에 손가락을 넣고 끝까지 버텨 최후의 1인이 되어 보세요!.",
        60,
    ),
    activity(
        "dopamine_04",
        "dopamine",
        "날계란 던지기",
        "가위바위보 진 사람들은 모두 도망가고 이긴 사람은 도망가는 사람들을 맞춰요.",
        60,
    ),
    activity(
        "dopamine_05",
        "dopamine",
        "뜨거운 숟가락 대기",
        "가위바위보 진 사람에게 달궈진 숟가락을 대 열에 대한 내성을 키워줘요 .",
        60,
    ),
    activity(
        "dopamine_06",
        "dopamine",
        "전기파리채 맞기",
        "가위바위보 진 사람이 전기파리채에 맞아 파리의 기분을 체험해봐요.",
        60,
    ),
    activity(
        "dopamine_07",
        "dopamine",
        "얼음물에 손 넣기",
        "가위바위보 진 사람은 얼음물에 손을 넣고 끝까지 버텨 최후의 1인이 되어 보세요!.",
        60,
    ),  
]   
